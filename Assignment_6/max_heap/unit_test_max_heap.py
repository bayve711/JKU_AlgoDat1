...
Changed on May 22, 2023 by Florian Beck
...
class UnitTestTemplate(unittest.TestCase):
    ...
    def test_heap_bottom_up_with_arr_without_downheap(self):
        ...
        for i in range(0, len(heap201)):
            self.assertEqual(heap201[i], heap_arr[i],
                             f"ERROR: Bottom-Up construction of heap with input array {heap201} had wrong element at "
                             f"index {i}")
    ...
    def test_heap_bottom_up_with_arr_with_single_downheap(self):
        ...
        for i in range(0, len(heap102)):
            self.assertEqual(heap102solution[i], heap_arr[i],
                             f"ERROR: Bottom-Up construction of heap with input array {heap102} had wrong element at "
                             f"index {i}")
